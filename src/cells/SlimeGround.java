...
public class SlimeGround extends Cell implements Cloneable{
	...
	public SlimeGround(int x, int y, int[] neighboringX, int[] neighboringY, int currentState, IEdgeCase edgeType, Map<Integer, String> colorMap,  Map<String, Double> parametersMap, SimulationModel myModel){
